...
class Giohang extends CI_Controller {
    ...
    public function index(){
        $this->data['title']='Hàng Chính Hiệu - Giỏ hàng của bạn';
    ...
    public function info_order(){
        ...
        if($this->form_validation->run() == TRUE){
            ...
            $this->data['title']='Hàng Chính Hiệu - Thông tin đơn hàng';
    ...
    public function thankyou(){
        if($this->session->userdata('info-customer')||$this->session->userdata('sessionKhachHang')){
            ...
            $this->email->to($list);
            $this->email->subject('Hàng Chính Hiệu');
        ...
        $this->data['title']='Hàng Chính Hiệu.vn - Kết quả đơn hàng';
