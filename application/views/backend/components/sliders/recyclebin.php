	...
	<div class="d-flex align-items-baseline justify-content-between mb-5">
		...
		<nav aria-label="breadcrumb">
			<ol class="breadcrumb">
				...
				<li class="breadcrumb-item">Quản lý sliders</li>
			...
			<div class="card border-0 flex-fill w-100">
				<div class="card-header border-0">
					...
					<div class="d-flex flex-column flex-md-row align-items-md-center justify-content-end">
						...
						<!-- Button -->
						<a type="button" class="btn btn-outline-danger ms-md-4" href="<?php echo base_url() ?>admin/sliders" role="button">
							Trở về
						</a>
					</div>
									...
									<td>
										...
										<div class="dropdown float-end">
											...
											<ul class="dropdown-menu">
												<li>
													<a class="dropdown-item" href="<?php echo base_url() ?>admin/sliders/restore/<?php echo $row['id'] ?>" role="button">
													<i class='bx bx-revision'></i> Khôi phục slider
													</a>
												</li>
												<li>
												...
												<li>
													<a class="dropdown-item text-danger" href="<?php echo base_url() ?>admin/sliders/delete/<?php echo $row['id'] ?>" onclick="return confirm('Bạn có chắn chắn muốn xóa slider này?')" role="button">
