			...
			<div class="card border-0 flex-fill w-100">
				<div class="card-header border-0">
					...
					<div class="d-flex flex-column flex-md-row align-items-md-center justify-content-end">
						...
						<!-- Button -->
						<a type="button" class="list-fuzzy-search mw-md-300px ms-md-auto mt-5 mt-md-0 mb-3 mb-md-0 btn btn-outline-danger ms-md-4" href="<?php echo base_url() ?>admin/customer" role="button">
							Trở về
						</a>
					</div>
									...
									<td>
										...
										<div class="dropdown float-end">
											...
											<ul class="dropdown-menu">
												<li>
													<a class="dropdown-item" href="<?php echo base_url() ?>admin/customer/restore/<?php echo $row['id'] ?>" role="button">
													<i class='bx bx-revision'></i> Khôi phục
													</a>
												</li>
												<li>
												...
												<li>
													<a class="dropdown-item text-danger" href="<?php echo base_url() ?>admin/customer/delete/<?php echo $row['id'] ?>" onclick="return confirm('Bạn có chắn chắn muốn xóa khách hàng này?')" role="button">
