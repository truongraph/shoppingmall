			...
			<div class="card border-0 flex-fill w-100">
				<div class="card-header border-0">
					...
					<div class="d-flex flex-column flex-md-row align-items-md-center justify-content-end">
						...
						<!-- Button -->
						<a type="button" class="list-fuzzy-search mw-md-300px ms-md-auto mt-5 mt-md-0 mb-3 mb-md-0 btn btn-primary ms-md-4" href="<?php echo base_url() ?>/admin/product/insert" role="button">
							Tạo mới sản phẩm
						</a>
						<!-- Button -->
					...
					<table class="table align-middle table-hover table-bordered">
						...
						<tbody class="list">
							<?php $stt = 0; foreach ($list as $row) : ?>
								...
								<td><?php $stt += 1;
												echo $stt; ?></td>
									<td><img src="public/images/products/<?php echo $row['img'] ?>" alt="<?php echo $row['name'] ?>" width="80px" height="50px"></td>
									<td class="key">
										<?php echo $row['name'] ?>
									</td>
									<?php
									...
									<td>
										...
										<div class="dropdown float-end">
											...
											<ul class="dropdown-menu">
												...
												<li>
													<a class="dropdown-item" href="admin/product/restore/<?php echo $row['id'] ?>" role = "button">
													<i class='bx bx-revision'></i> Khôi phục sản phẩm
													</a>
												</li>
												<?php  
													$quyen='';
												...
												<li>
													<a class="dropdown-item text-danger" href="admin/product/delete/'.$row['id'].'" role = "button">
