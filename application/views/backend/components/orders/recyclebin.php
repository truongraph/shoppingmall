			...
			<div class="card border-0 flex-fill w-100">
				<div class="card-header border-0">
					...
					<div class="d-flex flex-column flex-md-row align-items-md-center justify-content-end">
						...
						<!-- Button -->
						<a type="button" class="list-fuzzy-search mw-md-300px ms-md-auto mt-5 mt-md-0 mb-3 mb-md-0 btn btn-outline-danger ms-md-4" href="admin/orders" role="button">
							Trở về
						</a>
					</div>
					...
					<table class="table align-middle table-hover table-bordered">
						...
						<tbody class="list">
							...
							?>
								...
								<td><?php $stt += 1;
												echo $stt; ?></td>
									<td><a href="<?php echo base_url() ?>admin/orders/view/<?php echo $val['id'] ?>" class="text-danger fw-bold text-decoration-underline">#<?php echo $val['orderCode'] ?></a></td>
									...
									<?php
										switch ($val['status']) {
											case '0':
												echo '<span class="badge text-bg-secondary"><i class="bx bx-loader-circle"></i> Đang chờ duyệt</span>';
												break;
											case '1':
									...
									<td>
										...
										<div class="dropdown float-end">
											...
											<ul class="dropdown-menu">
												<li>
													<a class="dropdown-item" href="<?php echo base_url() ?>admin/orders/view/<?php echo $val['id'] ?>">
												...
												<li>
													<a class="dropdown-item text-danger" href="admin/orders/restore/<?php echo $val['id'] ?>" role = "button">
													<i class='bx bx-reset' ></i> Khôi phục đơn hàng
													</a>
												</li>
											</ul>
										</div>
